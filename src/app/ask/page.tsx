    ...
    <div className="px-4 md:px-6 py-6 space-y-5 max-w-[1200px] mx-auto">
      <section>
        ...
        <p className="text-sm text-muted-foreground mt-2 max-w-3xl leading-relaxed">
          ...
          indicators. Pick optional context (a project, a domain) to constrain the answer. Backed by
          the <span className="font-mono">treaty</span> serving endpoint via the Databricks AI
          Gateway.
        </p>
